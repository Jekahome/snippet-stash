...
В Rust по умолчанию вообще нет сборщика мусора. Память управляется через систему владения (ownership) и RAII
Компилятор вставляет вызовы освобождения в нужные места на этапе компиляции.
