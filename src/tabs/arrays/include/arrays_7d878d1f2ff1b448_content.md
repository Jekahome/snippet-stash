...
Доступ по индексу аналогичен `Vec (O(1))`, но он менее оптимален для операций, связанных только с концом структуры данных, потому что в памяти используется кольцевой буфер, и операции могут быть чуть сложнее.
